const Command = require('../customModules/Command.js')

const data = {
  name: 'ping',
  description: "Check if the bot is online, display the bot's ping in ms, and view the amount of servers the bot's in",
  action: (client, msg, knex) => {
